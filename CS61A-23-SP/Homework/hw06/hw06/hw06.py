...
class VendingMachine:
    ...
    def vend(self):
        if self.amount == 0:
            ...
            print('\'Please add $'+str(self.price-self.money)+' more funds.\'')    
        elif self.money>self.price:
            print('\'Here is your '+str(self.product)+' and $'+str(self.money-self.price)+' change.\'')
            self.amount-=1
            self.money=0
        else:
    ...
    def add_funds(self,money_added):
        if self.amount == 0:
            print('\'Nothing left to vend. Please restock. Here is your $'+str(money_added)+'.\'')
        else:
...
class VirFib():
    ...
    def next(self):
        if self.value == 0:
            VirFib_next = VirFib(1)
        else:
            VirFib_next = VirFib(self.value + self.last)
        VirFib_next.last = self.value
        return VirFib_next
