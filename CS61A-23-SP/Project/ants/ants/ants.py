...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not nearest_bee_place.is_hive:
            if not nearest_bee_place.bees == [] and self.lower_bound <= self.range <= self.upper_bound:
